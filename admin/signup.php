                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form action="signupaction.php" method="POST" enctype='multipart/form-data'>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="Text" placeholder="jhondoe" name="firstname"
                                    required>
                                <label for="floatingText">First name</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="Text" placeholder="jhondoe" name="lastname"
                                    required>
                            ...
                            <div class="mb-3">
                                <div class="input-group">
                                    <input type="password" class="form-control" id="password" name="password"
                                        aria-describedby="passwordToggle" placeholder="enter password here">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="Text" placeholder="jhondoe" name="userrole"
                                    required>
                                <label for="floatingText">user role</label>
                            </div>

                            <div class="form-floating mb-3">
                                <input type="file" class="form-control" id="Text" placeholder="jhondoe" name="img"
